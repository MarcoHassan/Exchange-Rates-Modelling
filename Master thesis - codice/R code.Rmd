...
```{r}
for( LAG in c(3, 6, 12) ) ## for 1 time period forecast not working. xnew is interpreted as a vector and not as a matrix and the column dimension is lost giving rise to distortions in the model comparison.
{
...
lines(data$rwPred3_CHUS,col=2, lwd = 2)
lines(data$strPred3_CHUS, col = 3, lwd = 2)
lines(data$varPred3_CHUS, col = 4, lwd = 2)
```
