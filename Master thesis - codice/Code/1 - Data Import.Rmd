...
Symbols <- c("LRUN64TTUSM156S", "LRUN64TTJPM156S", "LMUNRRTTCHM156S", "LMUNRRTTGBM156S") #F not seasonally adjusted.
...
data <- data["1986-09-01/2007-01-01"] ## extract a complete dataset without NA; notice if you run the analysis with M1 you have complete data until 2013.
...
```{r}
data <- cbind(data[,27:ncol(data)], data[,1:3])
```
