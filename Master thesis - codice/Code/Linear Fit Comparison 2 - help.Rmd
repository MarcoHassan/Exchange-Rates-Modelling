...
```{r}
plot(tail(data$EX_UKUS, 50), ylab="Rates", main="Linear Estimators - 1 Lag Out of Sample", 
     grid.col = NA, col = 1)
lines(data$rwPred1_UKUS,col= 2, lwd = 2)
lines(data$strPred1_UKUS, col = "orange", lwd = 2)
lines(data$varPred1_UKUS, col = "yellow", lwd = 2)
lines(data$vecmPred1_UKUS, col = "salmon", lwd = 2)
